...
urlpatterns = [
    ...
    path("performance-motorista/", views.performance_motoristas, name="performance_motoristas"),
    path("jornada-motoristas/", views.jornada_motoristas, name="jornada_motoristas"),
