    ...
    if viagens_eco_query.exists():
        ...
        for unidade_id in unidades_ids:
            try:
                ...
                rpms = []
                motor_ocioso_count = 0  # Contador para motor ocioso
                total_registros = 0     #  Total de registros processados
                motor_trabalhando_count = 0
                ...
                for v in viagens_unidade:
                    ...
                    # Condição para motor ocioso (RPM = 0 e velocidade > 0)
                ...
                if rpms or total_registros > 0:
                    ...
                    perc_azul = (faixa_azul / total_registros * 100) if total_registros > 0 and velocidade_valor > 0 else 0
                    perc_verde = (faixa_verde / total_registros * 100) if total_registros > 0 and velocidade_valor > 0 else 0
                    perc_amarela = (faixa_amarela / total_registros * 100) if total_registros > 0 and velocidade_valor > 0 else 0
                    perc_vermelha = (faixa_vermelha / total_registros * 100) if total_registros > 0 and velocidade_valor > 0 else 0
