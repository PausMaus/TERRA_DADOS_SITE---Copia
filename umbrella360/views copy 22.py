    ...
    if viagens_eco_query.exists():
        ...
        for stats in unidades_stats:
            try:
                ...
                # Calcular percentuais baseados no total de registros
                perc_azul = (stats['faixa_azul_count'] / total_pontos * 100) if total_pontos > 0 else 0
                perc_verde = (stats['faixa_verde_count'] / total_pontos * 100) if total_pontos > 0 else 0
                perc_amarela = (stats['faixa_amarela_count'] / total_pontos * 100) if total_pontos > 0 else 0
                perc_vermelha = (stats['faixa_vermelha_count'] / total_pontos * 100) if total_pontos > 0 else 0
                perc_ocioso = (stats['motor_ocioso_count'] / total_pontos * 100) if total_pontos > 0 else 0
