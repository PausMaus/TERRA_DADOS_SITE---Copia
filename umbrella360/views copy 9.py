...
def detalhes_unidade(request, unidade_id):
    ...
    # 🔥 NOVO: Obter parâmetro de data selecionada
    ...
    # 🔥 NOVO: Obter todas as datas disponíveis
    ...
    # 🔥 NOVO: Determinar data a ser exibida
    ...
    # 🔥 NOVO: Filtrar viagens eco pelo dia selecionado
    timeline_data = []
    if data_selecionada and viagens_eco_all.exists():
        ...
        viagens_eco = viagens_eco_all.filter(
            timestamp__gte=timestamp_inicio,
            timestamp__lte=timestamp_fim
        )
        
        for viagem_eco in reversed(viagens_eco):
            try:
    ...
    context = {
        ...
        # 🔥 NOVO: Dados para seletor de data
