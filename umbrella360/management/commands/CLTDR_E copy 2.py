        ...
        for unidade_id in lista_unidades:
            ...
            try:
                ...
                if result and isinstance(result, list):
                    ...
                    unidade_obj = Veiculo.objects.filter(id_wialon=unidade_id)
                    if unidade_obj:
                        for index, row in tqdm(df_messages.iterrows(), total=len(df_messages), desc="Atualizando Viagem_eco", unit="msg"):
