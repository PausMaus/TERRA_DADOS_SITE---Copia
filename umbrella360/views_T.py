...
def performance_motoristas(request):
    ...
    # 🔥 OTIMIZAÇÃO 2: Limitar a 200 motoristas únicos (CORREÇÃO)
    # Primeiro pegar IDs distintos, depois limitar
    motoristas_ids_query = viagens_eco_query.values_list('nome_motorista_id', flat=True)
    motoristas_ids = list(motoristas_ids_query)  # Slice depois de materializar
