        ...
        for unidade_id in unidades_ids:
            try:
                ...
                for v in viagens_unidade:
                    ...
                    if rpm_valor > 0 and velocidade_valor > 1:
                ...
                if rpms or total_registros > 0:
                    ...
                    score = (perc_verde * 1.0) + (perc_azul * 0.8) - (perc_amarela * 0.5) - (perc_vermelha * 0.5) - (perc_ocioso * 0.3)  # 🔥 NOVO: penalizar motor ocioso
